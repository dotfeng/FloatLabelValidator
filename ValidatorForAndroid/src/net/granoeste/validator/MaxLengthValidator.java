...
public class MaxLengthValidator extends BaseValidator {
    ...
    public MaxLengthValidator(final int max, final Context context) {
    	super(context.getString(R.string.errors_msg_max_length, max));
        mMax = max;
    }
    
    public MaxLengthValidator(final int max, final String errorMessage) {
        super(errorMessage);
        mMax = max;
    }
