...
public class EmailValidator extends BaseValidator {
    ...
    org.apache.commons.validator.EmailValidator mValidator;

    public EmailValidator(final Context context) {
    	super(context.getString(R.string.errors_msg_email));
        mValidator = org.apache.commons.validator.EmailValidator.getInstance();
    }
